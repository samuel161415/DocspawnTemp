                ...
                <div class="flex flex-wrap mb-10">
                    <div v-for="integration in filteredIntegrations"
                        ...
                        <div class="flex space-x-3">
                            ...
                            <p class="text-lg font-medium font-poppins pt-2 text-surface-600">{{ integration.title }}</p>
                        </div>
                        <Button label="Connect" severity="surface-500"
                            class="bg-surface-100 w-4/5 h-10 text-surface-500 font-thin btn" />
                        <p class="text-surface-500 text-sm font-poppins desc pr-1">{{ integration.description }}</p>
                    </div>
                </div>
            </div>
        </div>
