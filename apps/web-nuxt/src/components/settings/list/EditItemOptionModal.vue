        ...
        <template #container="{ closeCallback }">
            <div class="bg-white w-[45rem] rounded-lg min-h-64 py-5 px-3 overflow-scroll no-scrollbar">
                <div class="flex bg-white sticky justify-between items-center ml-5 mb-3">
                    ...
                    <i class="pi pi-times cursor-pointer p-dialog-header-icon mr-4" @click="handleCancel($event)" />
                </div>
                ...
                <template #container="{ message, acceptCallback, rejectCallback }">
                    <div class="rounded px-6 mt-5 py-8 ">
                        ...
                        <div class="flex justify-end gap-2 mt-4">
                            <Button label="Save" severity="success" lick="acceptCallback" size="small" @click="handleEditItem"></Button>
                            <Button label="Close" outlined lick="rejectCallback" severity="secondary" size="small" text @click="cancelButton"></Button>
                        </div>
                    </div>
                </template>
            </ConfirmPopup>
