        ...
        <div class="flex flex-col gap-6">
            <Panel header="General information">
                <div class="flex flex-col gap-4">
                    ...
                    <InputText class="w-full" id="groupname" v-model="groupName" aria-describedby="groupname-help" required/>
                </div>
            </Panel>
            <Panel header="Edit users">
                <div class="flex flex-col gap-3">
                    ...
                    <MultiSelect v-model="selectedUsers" display="chip" :options="users" :optionLabel="optionLabelGetter" filter :filterFields="['firstName', 'lastName']"
                        placeholder="Select users" :maxSelectedLabels="10" class="w-full" />
                </div>
            </Panel>
            <Panel header="Template permissions">
                <div class="flex flex-col gap-3">
                    ...
                    <div class="flex flex-col gap-2">
                        <MultiSelect v-model="selectedTemplateFills" display="chip" :options="templates" optionLabel="name" filter
                    ...
                    <div class="flex flex-col gap-2">
                        <MultiSelect v-model="selectedTemplateEdits" display="chip" :options="templates" optionLabel="name" filter
                            placeholder="Choose templates" :maxSelectedLabels="5" class="w-full" />
                    </div>
                </div>
            </Panel>
