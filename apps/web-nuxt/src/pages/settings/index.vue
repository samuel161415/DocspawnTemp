<template>
  <div
    class="h-full w-full bg-white overflow-scroll no-scrollbar rounded-lg ml-4"
  >
    <div class="px-8 py-8 w-full">
      <div class="py-2 mx-3">
        ...
        <div class="flex justify-between">
          ...
          <div class="w-64 mt-5">
            <p
              class="text-surface-600 flex font-poppins text-lg font-normal justify-center"
            >
              Avatar
            </p>
            <div
              class="mt-2 relative flex cursor-pointer hover:opacity-40 ml-4 justify-center"
            ...
            >
              <Avatar
                v-if="avatarImage"
                :image="avatarImage"
                class="text-xl mt-1 rounded-full border object-fill"
                size="xlarge"
                shape="circle"
                style="
              ...
              <i
                v-show="showCamera"
                class="pi pi-camera absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 cursor-pointer text-black text-4xl"
              ></i>
            </div>
          </div>
        </div>
        ...
        <div class="mt-5">
          ...
          <div class="flex justify-between mt-3">
            ...
            <span class="relative flex w-full">
              <i
                class="pi pi-lock absolute top-1/3 z-50 left-3 text-surface-400 dark:text-surface-600"
                style="color: rgb(117, 119, 120)"
              ></i>
              <Password
                v-model="password"
        ...
        <div
          id="language-region"
          :class="{
            'mt-5': isTyping && password != '',
            'mt-28': !isTyping || password === '',
          }"
        >
          <div class="">
            <p class="text-surface-600 font-poppins text-xl font-medium">
          ...
          <div class="mt-5">
            ...
            <Dropdown
              ...
              :options="cities"
              option-label="name"
              placeholder="Asian/Kuala Lumpur"
              style="width: 100%; height: 44px"
              class="flex justify-center mt-3 font-poppins"
            />
          </div>

          <div class="flex mt-5">
            <Checkbox
              v-model="notifyTimeZone"
              input-id="notifyTimeZone"
              name="notifyTimeZone"
            ...
            <label
              for="notifyTimeZone"
              class="ml-4 text-surface-500 font-poppins text-lg font-normal"
            >
        ...
        <div id="time-date-format" class="mt-20 mb-48">
          ...
          <div class="mt-3 flex justify-between w-1/2">
            <div class="flex w-1/2">
              ...
              <label
                for="Sunday"
                class="text-surface-500 font-poppins text-lg ml-2"
                >Sunday</label
              >
            </div>
    ...
    <Dialog
      v-model:visible="openConfirmationModal"
      group="headless"
      modal
      :style="{ width: '29rem' }"
    >
      <template #container>
        <div class="bg-white rounded-lg px-5 py-14">
          ...
          <span class="mt-2 font-poppins text-base text-surface-600"
            >Are you sure you want to change your password?</span
          >
