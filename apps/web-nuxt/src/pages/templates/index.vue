          ...
          <div class="flex w-full items-center justify-between mb-4">
            ...
            <div class="flex space-x-5 ">
              <span class="space-x-3 cursor-pointer" @click="handleDisplayformat('list')">
                <i class="pi pi-list text-lg font-bold mt-1" :class="[displayFormat != 'list' ? '  text-[#4b5563]' : 'pi pi-list text-primaryBlue']"></i>
                <span
                  class="text-lg font-poppins font-normal hover:text-primaryBlue"
...
function handleDisplayformat(format) {
